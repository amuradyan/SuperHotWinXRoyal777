...
public class SequenceGeneratorTest {
  ...
  public void testWhenTheLengthOfTheSequenceNegativeTheOutputShouldBeAnEmptyWhenTheProbabilityIs0() {
    var sequence = WeightedCoin.flipACoinNTimes(0, -1);
  ...
  public void testWhenLengthIs0AndProbabilityIs0() {
    var sequence = WeightedCoin.flipACoinNTimes(0, 0);
    assertTrue(sequence.isEmpty());
  }
  ...
  public void testWhenLengthIs0AndProbabilityIs1() {
    var sequence = WeightedCoin.flipACoinNTimes(1, 0);
    assertTrue(sequence.isEmpty());
  }
  ...
  public void testWhenProbabilityIsHigherThan100() {
    var sequenceOf100 = WeightedCoin.flipACoinNTimes(100, 10);
    var sequenceOf101 = WeightedCoin.flipACoinNTimes(101, 10);
  ...
  public void testWhenProbabilityIsNegative() {
    var sequenceOf0 = WeightedCoin.flipACoinNTimes(0, 10);
    var sequenceOfMinus1 = WeightedCoin.flipACoinNTimes(-1, 10);
  ...
  public void testWhenProbabilityIs0() {
    var sequence = WeightedCoin.flipACoinNTimes(0, 10);
  ...
  public void testWhenProbabilityIs100() {
    var sequence = WeightedCoin.flipACoinNTimes(100, 10);
  ...
  public void testWhenProbabilityIs50() {
    var sequence = WeightedCoin.flipACoinNTimes(50, 10000);
  ...
  public void testWhenProbabilityIs20() {
    var sequence = WeightedCoin.flipACoinNTimes(20, 10000);
